...
! turns a true into false : 0

Bob gets a raise

Is the customer of legal age? true
...
A long int takes up 4 bytes

A float takes up 4 bytes

A double takes up 8 bytes

I'm bigger then you may have heard -2147483648

How Many Bits? 7


finalValue: 3 myMultiplier: 2 myIncrementor: 1

finalValue: 7 myMultiplier: 4 myIncrementor: 2

finalValue: 15 myMultiplier: 8 myIncrementor: 3

finalValue: 31 myMultiplier: 16 myIncrementor: 4

finalValue: 63 myMultiplier: 32 myIncrementor: 5

finalValue: 127 myMultiplier: 64 myIncrementor: 6

Top Value: 127

Guess My Secret Number: 2
Guess My Secret Number: 4
Guess My Secret Number: 5
Guess My Secret Number: 23
Guess My Secret Number: 12
Guess My Secret Number: 10
You Got It

What Size of Shirt (S,M,L): L
